...
/**
 * AI tool that provides macro recording capabilities for the LLM.
...
public class ImageJMacroTool implements AiToolPlugin {
	...
	@Tool(value = {
		"Returns: A list of ImageJ macro function category names"
	})
	...
	public String listMacroFunctionsByCategory(@P("category") String category) {
		...
		List<MacroFunctionRegistry.MacroFunction> functions = MacroFunctionRegistry.getByCategory(category);
	...
	public String startRecorder() {
		try {
			...
			// instance to front if it's already open (see ij.plugin.frame.Recorder constructor)
    ...
    @Tool(value = {
    	"Returns: A detailed ImageJ Macro guide for YOU, the LLM"
	})
